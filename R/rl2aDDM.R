...
rl2aDDM <- function(n, sigma, lambda, theta, d, fixation_time_up, fixation_time_down, 
  ...
  rt <- create.rt(n = n,  sigma = sigma, lambda = lambda, theta = theta, d = d, V = 0, 
