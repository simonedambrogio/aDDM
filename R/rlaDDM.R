...
rlaDDM <- function(n, sigma, lambda, d, fixation_time_up, fixation_time_down, 
  ...
  raDDM_one <- function( n, up, down, sigma, lambda, d, V = 0, first_fixation_time_up, first_fixation_time_down, 
  ...
  create.rt <- function(n,  sigma, lambda, d, V = 0, 
                        first_fix_time, non_first_fix_time, trans_time, non_dec_time ) {
    
    rt <- pblapply(1:n_up_down, function(i){
      
      rt <- raDDM_one( n = n, up = up_down[i, 1], down = up_down[i, 2], sigma = sigma, lambda = lambda, d = d, V = 0, 
  ...
  rt <- create.rt(n = n,  sigma = sigma, lambda = lambda, d = d, V = 0, 
...
#source("https://raw.githubusercontent.com/simonedambrogio/Useful_R_Functions/master/df_probability.R")
...
#sim_data <- rlaDDM(n = 100, sigma = 0.0233, lambda = 1.3, V = 0, d = 0.000065, value_up_boundary = seq(1,20,2), value_down_boundary = seq(1,20,2), 
